...
(function($) {
    ...
    **/
    var launch = new Date(2016, 10, 21, 12, 00, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('Notre site n\'est pas encore prêt, mais restez connecté, nous arrivons bientôt...');
        }
    }
})(jQuery);
/******************************************************************************************************************************
